...
class StudentController extends Controller
{
    ...
    {
        $Student = Student::all();
        return view('dashboard.pages.student.all',compact('Student'));
    }
    ...
    public function certifical($id)
    {
        $Student = Student::find($id);

        $course = Course::where('department_id',$Student->department_id)->get()->first();

        $result = Result::where('student_id',$id)->where('course_id',$course->id)->get()->first();


            return view('dashboard.pages.student.certifical', compact('Student','result'));
