...
use App\Http\Controllers\HamadaController;
...
Route::group(['namespace'=>'Backend','middleware' => 'IsAdmin'], function () {
    ...
    Route::group(['prefix' => 'student'], function () {
        ...
        Route::get('/all_students','StudentController@all_students')->name('student.all');
        Route::get('/certifical/{id}','StudentController@certifical');
...
Route::get('file-export', [HamadaController::class, 'fileExport'])->name('file-export');
