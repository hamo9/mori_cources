  ...
  <script src="{{asset('additional/vendor/jquery/jquery.min.js')}}"></script>
  <script src="{{asset('vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>

  <!-- Core plugin JavaScript-->
  <script src="{{asset('additional/vendor/jquery-easing/jquery.easing.min.js')}}"></script>
  ...
  <script src="hamada/js/popper.min.js"></script>
  <script src="hamada/js/bootstrap.min.js"></script>
